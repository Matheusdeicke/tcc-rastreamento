...
<div class="max-w-3xl mx-auto p-4 sm:p-6">
  <h3 class="text-2xl font-bold text-brand-800">Novo kit</h3>
  ...
  <form method="POST" action="{{ route('kits.store') }}"
    ...
    <div>
      ...
      <input name="nome" required value="{{ old('nome') }}"
    ...
    <div>
      ...
      <textarea name="descricao" rows="3"
                class="w-full rounded-lg border-gray-300 focus:border-brand-accent focus:ring-brand-accent">{{ old('descricao') }}</textarea>
    </div>
